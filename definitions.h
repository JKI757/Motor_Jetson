...
#define MAX_RIGHT_STEERING_US 1150
#define MAX_LEFT_STEERING_US 1900
#define CENTER_STEER_US (MAX_RIGHT_STEERING_US-MAX_LEFT_STEERING_US) / 2 + MAX_LEFT_STEERING_US
